...
HEALTH_REQUIRE_EXPECTED_RUN="${HEALTH_REQUIRE_EXPECTED_RUN:-true}"
HEALTH_REQUIRE_SUCCESS="${HEALTH_REQUIRE_SUCCESS:-true}"
...
if [[ "$RUN_HEALTH" == "true" ]]; then
  HEALTH_CMD=(
    ...
    REQUIRE_EXPECTED_RUN="$HEALTH_REQUIRE_EXPECTED_RUN"
    REQUIRE_SUCCESS="$HEALTH_REQUIRE_SUCCESS"
